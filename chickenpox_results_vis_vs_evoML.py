...
# results = pd.read_excel("chickenpox_evoML.xlsx", sheet_name="All")
filepath = Path('Chickenpox/Tables/chickenpox_vs_evoML.xlsx')
filepath.parent.mkdir(parents=True, exist_ok=True)
results = pd.read_excel(filepath, sheet_name="Sheet1")

results = pd.melt(results, id_vars="Model", var_name="Method", value_name="MAE")
# vis1_yticks = [0, 1, 2, 3, 4, 5, 6, ""]
#Plot settings
sns.set_theme()
...
vis1.set_yticklabels(fontsize = 12)
...
results_pc = pd.read_excel(filepath, sheet_name="Sheet1")
